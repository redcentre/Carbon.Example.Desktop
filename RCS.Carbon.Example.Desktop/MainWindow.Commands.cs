...
using Constants = RCS.Carbon.Example.Desktop.Model.Constants;
...
partial class MainWindow
{
	...
	void HelpExecute(object sender, ExecutedRoutedEventArgs e) => Process.Start(new ProcessStartInfo("https://github.com/redcentre/RCS.Carbon.Example.Desktop") { UseShellExecute = true });
