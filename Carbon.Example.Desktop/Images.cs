...
namespace Carbon.Example.Desktop
{
	static class Images
	{
		...
		public static BitmapImage IconDirClosed = new BitmapImage(new Uri("/Resources/DirClosed16.png", UriKind.Relative));
		public static BitmapImage IconDirOpen = new BitmapImage(new Uri("/Resources/DirOpen16.png", UriKind.Relative));
