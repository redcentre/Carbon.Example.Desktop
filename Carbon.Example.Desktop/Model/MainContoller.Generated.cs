//================================================================================================
// <auto-generated>
// This code was generated by a tool on machine HERON at local time 12/09/2022 09:57:35.
...
namespace Carbon.Example.Desktop
{
	partial class MainController
	{
		...
		Exception _vmetaError;
		[GeneratedCode("TextTemplatingService", "17.0.0.0")]
		public Exception VmetaError
		{
			get => _vmetaError;
			set
			{
				if (_vmetaError != value)
				{
					_vmetaError = value;
					OnPropertyChanged(nameof(VmetaError));
				}
			}
		}

		Exception _genTabError;
		[GeneratedCode("TextTemplatingService", "17.0.0.0")]
		public Exception GenTabError
		{
			get => _genTabError;
			set
			{
				if (_genTabError != value)
				{
					_genTabError = value;
					OnPropertyChanged(nameof(GenTabError));
				}
			}
		}
