//================================================================================================
// <auto-generated>
// This code was generated by a tool on machine OWL at local time 17/04/2025 05:44:03.
...
namespace Carbon.Example.Desktop.Model
{
	partial class MainController
	{
		...
		public AppNode? SelectedNode
		{
			...
			set
			{
				if (_selectedNode != value)
				{
					...
					Application.Current.Dispatcher.InvokeAsync(async () => await AfterNodeSelectAsync());
				}
			}
		}
		...
		[GeneratedCode("TextTemplatingService", "17.0.0.0")]
		public string? SaveReportName
		{
			get => _saveReportName;
			set
			{
				string? newval = string.IsNullOrEmpty(value) ? null : value;
				if (_saveReportName != newval)
				{
					_saveReportName = newval;
					OnPropertyChanged(nameof(SaveReportName));
					ValidateSaveName();
				}
			}
		}
		...
		[GeneratedCode("TextTemplatingService", "17.0.0.0")]
		public string? SaveReportFeedback
		{
			get => _saveReportFeedback;
			set
			{
				string? newval = string.IsNullOrEmpty(value) ? null : value;
				if (_saveReportFeedback != newval)
				{
					_saveReportFeedback = newval;
					OnPropertyChanged(nameof(SaveReportFeedback));
				}
			}
		}

		bool _isSaveNameValid;
		[GeneratedCode("TextTemplatingService", "17.0.0.0")]
		public bool IsSaveNameValid
		{
			get => _isSaveNameValid;
			set
			{
				if (_isSaveNameValid != value)
				{
					_isSaveNameValid = value;
					OnPropertyChanged(nameof(IsSaveNameValid));
				}
			}
		}
